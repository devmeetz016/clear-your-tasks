      ...
      <div className="mx-auto max-w-2xl">
        ...
        <Card className="p-6 mb-6 shadow-card bg-card border-0">
          <div className="flex gap-3">
            ...
            <Button onClick={addTodo} disabled={!newTodo.trim()} className="bg-gradient-primary hover:shadow-hover transition-smooth border-0 text-lg rounded-xl bg-fuchsia-950 hover:bg-fuchsia-800 text-[#c2480f]">
