        ...
        <Card className="p-6 mb-6 shadow-card bg-card border-0">
          <div className="flex gap-3">
            ...
            <Button 
              ...
              className="bg-gradient-primary hover:shadow-hover transition-smooth border-0"
            >
          ...
          {(['all', 'active', 'completed'] as FilterType[]).map((filterType) => (
            <Button
              ...
              className={cn(
                ...
                filter === filterType 
                  ? "bg-gradient-primary shadow-hover border-0" 
          ...
          {filteredTodos.length === 0 ? (
            ...
            filteredTodos.map((todo) => (
              <Card 
                key={todo.id} 
                className={cn(
                  "p-4 bg-card border-0 shadow-todo hover:shadow-hover transition-smooth",
